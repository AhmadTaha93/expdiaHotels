...
this.additionalProperties.put(name, value);
    ...
    public String toString() {
        return "Hotel{" + "offerDateRange=" + offerDateRange + ", destination=" + destination + ", hotelInfo=" + hotelInfo + ", hotelUrgencyInfo=" + hotelUrgencyInfo + ", hotelPricingInfo=" + hotelPricingInfo + ", hotelUrls=" + hotelUrls + ", hotelScores=" + hotelScores + ", additionalProperties=" + additionalProperties + '}';
    }
