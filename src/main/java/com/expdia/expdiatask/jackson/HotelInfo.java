...
this.additionalProperties.put(name, value);
    ...
    public String toString() {
        return "HotelInfo{" + "hotelId=" + hotelId + ", hotelName=" + 
                hotelName + ", hotelDestination=" + hotelDestination
                + ", hotelDestinationRegionID=" + hotelDestinationRegionID 
                + ", hotelLongDestination=" + hotelLongDestination + 
                ", hotelStreetAddress=" + hotelStreetAddress + ", hotelCity=" + 
                hotelCity + ", hotelProvince=" + hotelProvince + 
                ", hotelCountryCode=" + hotelCountryCode + ", hotelLocation=" + 
                hotelLocation + ", hotelLatitude=" + hotelLatitude + 
                ", hotelLongitude=" + hotelLongitude + 
                ", hotelStarRating=" + hotelStarRating +
                ", hotelGuestReviewRating=" + hotelGuestReviewRating + 
                ", travelStartDate=" + travelStartDate + ", travelEndDate=" 
                + travelEndDate + ", hotelImageUrl=" + hotelImageUrl + 
                ", carPackageScore=" + carPackageScore + ", description=" +
                description + ", distanceFromUser=" + distanceFromUser +
                ", language=" + language + ", movingAverageScore=" +
                movingAverageScore + ", promotionAmount=" + promotionAmount 
                + ", promotionDescription=" + promotionDescription + ", promotionTag=" + promotionTag + ", rawAppealScore=" + rawAppealScore + ", relevanceScore=" + relevanceScore + ", statusCode=" + statusCode + ", statusDescription=" + statusDescription + ", carPackage=" + carPackage + ", allInclusive=" + allInclusive + ", additionalProperties=" + additionalProperties + '}';
    }
