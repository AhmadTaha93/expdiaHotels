...
this.additionalProperties.put(name, value);
    ...
    public String toString() {
        return "HotelPricingInfo{" + "averagePriceValue=" + averagePriceValue + 
                ", totalPriceValue=" + totalPriceValue + ", originalPricePerNight=" +
                originalPricePerNight + ", hotelTotalBaseRate=" + hotelTotalBaseRate +
                ", hotelTotalTaxesAndFees=" + hotelTotalTaxesAndFees + ", currency=" +
                currency + ", hotelTotalMandatoryTaxesAndFees=" + hotelTotalMandatoryTaxesAndFees
                + ", percentSavings=" + percentSavings + ", drr=" + drr + 
